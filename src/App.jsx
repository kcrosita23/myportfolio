...
import { Moon, Sun, Menu, X, Mail, Phone, MapPin, Github, Linkedin, ExternalLink, Code, Palette, Smartphone, Globe } from 'lucide-react';
...
const App = () => {
  ...
  const experiences = [
    {
      ...
      description: 'Contributed as one of the engineers building enterprise web applications using React, Node.js, and cloud technologies.'
    },
    {
    ...
    },
    {
      ...
      description: 'Team leader of software developer interns, Refined and improved the UI/UX of the company system and website.'
    }
  ];
  ...
  return (
    <ThemeWrapper isDark={isDark}>
      ...
      />
      <HeroSection isDark={isDark} scrollY={scrollY} scrollToSection={scrollToSection} />
      ...
      <ContactSection isDark={isDark} Mail={Mail} Phone={Phone} MapPin={MapPin} Github={Github} Linkedin={Linkedin} />
