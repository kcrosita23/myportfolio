  ...
  const Navbar = ({ isDark, setIsDark, isMenuOpen, setIsMenuOpen, scrollY, navItems, scrollToSection }) => {
    return (
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center space-x-4 hover:text-blue-600">
              ...
              >
                {isDark ? <Sun size={20} className='hover:text-blue-600' /> : <Moon size={20} className='text-white hover:text-blue-600' />}
              </button>
